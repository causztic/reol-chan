...
const { SM_UPDATES_ID, GENERAL_ID, TEST_ID, MUSIC_VOICE_ID, REOL_CHAN_ID, ANNOUNCEMENTS_ID, PHOTO_GALLERY_ID } = require("./constants");
...
client.on("message", message => {
  ...
  if (Math.random() <= 0.25 && message.author.id !== '294349205391147009' && message.content.slice(0, 2) !== "r!"){
    ...
    } else if (message.channel.id === (((process.env.npm_config_test !== undefined) ? TEST_ID : ANNOUNCEMENTS_ID)
